...
class Project extends Model {
  ...
  const Project._internal({required this.id, required name, cover, emoji, color, todos, sections, createdAt, updatedAt}): _name = name, _cover = cover, _emoji = emoji, _color = color, _todos = todos, _sections = sections, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Project({String? id, required String name, String? cover, String? emoji, String? color, List<Todo>? todos, List<Section>? sections}) {
  ...
  Project copyWith({String? id, String? name, String? cover, String? emoji, String? color, List<Todo>? todos, List<Section>? sections}) {
    return Project._internal(
      id: id ?? this.id,
      name: name ?? this.name,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'cover': _cover, 'emoji': _emoji, 'color': _color, 'todos': _todos?.map((Todo? e) => e?.toJson()).toList(), 'sections': _sections?.map((Section? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.hasMany(
      ...
      associatedKey: Section.PROJECTID
    ));
